function compatible(works_min, works_max, tweak_compatibility) {
    ...
    if (currentiOS < works_min) {
        el.innerHTML = "Your version of iOS is too old for this App. This App works on " + tweak_compatibility + ".";
        el.classList.add("red")
    } else if(currentiOS > works_max) {
        el.innerHTML = "Your version of iOS is too new for this App. This App works on " + tweak_compatibility + ".";
        el.classList.add("red")
    } else if(String(currentiOS) != "NaN") {
        el.innerHTML = "This App works on your device ! &#x1f60a;";
